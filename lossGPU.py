# -*- coding: utf-8 -*-
"""
Created on Mon Mar  1 06:47:31 2021
...
class SSSLoss(nn.Module):
    ...
    def __init__(self, n_fft, alpha=1.0, overlap=0.75, eps=1e-7):
        ...
        self.melspec=torchaudio.transforms.MelSpectrogram(AUDIO_SAMPLE_RATE,n_fft=n_fft,f_min =0,f_max=8000, 
                                  n_mels=80,win_length=n_fft,hop_length=int(n_fft/4),pad=0)
